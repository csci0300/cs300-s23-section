...
define run-fun
  if $fun_file_set == 0
    ...
    if $fun_argc == 0
      eval "shell qemu-x86_64 -g 12948 fun \"%s\" & sleep 0.2", $fun_file
    end
    if $fun_argc == 1
      eval "shell qemu-x86_64 -g 12948 fun \"%s\" \"%s\" & sleep 0.2", $fun_file, $fun_arg0
    end
    if $fun_argc == 2
      eval "shell qemu-x86_64 -g 12948 fun \"%s\" \"%s\" \"%s\" & sleep 0.2", $fun_file, $fun_arg0, $fun_arg1
    end
    if $fun_argc == 3
      eval "shell qemu-x86_64 -g 12948 fun \"%s\" \"%s\" \"%s\" \"%s\" & sleep 0.2", $fun_file, $fun_arg0, $fun_arg1, $fun_arg2
    end
    if $fun_argc == 4
      eval "shell qemu-x86_64 -g 12948 fun \"%s\" \"%s\" \"%s\" \"%s\" \"%s\" & sleep 0.2", $fun_file, $fun_arg0, $fun_arg1, $fun_arg2, $fun_arg3
    end
